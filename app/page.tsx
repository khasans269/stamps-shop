  ...
  return (
    <main className="flex flex-1 flex-col items-center justify-center bg-zinc-50 px-6 py-16 text-center">
      ...
      <p className="mb-10 max-w-xl text-lg text-zinc-600">
        Инструменты для керамики, которые я создаю сам — с вниманием к деталям и любовью к ремеслу.
        Здесь вы найдёте штампы, алфавиты, сита, цикли и другие инструменты для работы с глиной. А если у Вас есть своя идея — можно заказать авторский штамп с Вашим логотипом или эскизом.
